...
import {scoutingRobert, morphological, designConcepts, rampAssembly, robertOld, flowchart, robertVid, spinning} from '../components/Data'
      ...
      <h1>SCOUTING ROBERT</h1>
        <p><strong>The challenge: </strong>Scouting Robert is our third-year design project. The goal was to construct an autonomous
         ...
         <strong>Preliminary design: </strong>To ensure stable performance as the robot ascends the ramp, a key concept involves incorporating stepped wheels. The inner step rests on top of the ramp,
          ...
          detecting the ramp, pole and course perimeter. The standard 3 view and model view representations of the initial design assembly of the robot can be seen below. <br/>
          ...
          <img src={flowchart} class="modal-imgs" style={{width:"100%"}}></img>
          <strong>Result: </strong>
          The final robot, weighing 648g, completed the course in 28s, securing 3rd place out of 21 competing groups.
        </p>
        <video class="video" src={robertVid} type="video/mp4" controls>This browser does not support the video tag.</video><br/>
    </div>
  )
}
