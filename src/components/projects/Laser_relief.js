...
import {picoway, cryogenic, valveControl, nozzle, footPedal, onOff} from '../media/Data'
...
function Laser_relief() {
  return (
    <div>
      ...
      <img src={valveControl} class='modal-imgs' style={{width:'50%'}}></img><br/>
      Next, to incorporate real-time monitoring for skin temperature and the distance form the cryogenic nozzle to the skin, a temperature sensor, a ToF sensor and an LCD are used for data collection and display. These components, controlled by a seperate Arduino board, along with the cryogenic nozzle are chosen to be attached to the laser handpiece as shown below, since this configuration prevents delay and inconvenience caused by switching equipment during treatment.<br/><br/>
      <img src={nozzle} class='modal-imgs' style={{width:'30%'}}></img><br/>
